...
from .models import CustomUsuario, CustomUsuarioAdmin, Entrega_medicamentos, Entrega_medicamentosAdmin, Entrega_pendiente, Entrega_pendienteAdmin, Ficha_pacienteAdmin, MedicamentoAdmin, Paciente, Medicamento, PacienteAdmin, Personal, PersonalAdmin, Ficha_paciente, Receta_medica, Receta_medicaAdmin
