    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_paciente', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='polls.paciente')),
                ('id_personal', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='polls.personal')),
            ],
        ),
        migrations.CreateModel(
            name='Ficha_paciente',
